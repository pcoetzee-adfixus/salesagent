...
class AggregatedTotals(BaseModel):
    ...
    clicks: Annotated[
        float | None, Field(description="Total clicks across all media buys (if applicable)", ge=0.0)
    ] = None
...
class Totals(BaseModel):
    ...
    video_completions: Annotated[
        float | None, Field(description="DEPRECATED: Use completed_views instead", ge=0.0)
    ] = None
