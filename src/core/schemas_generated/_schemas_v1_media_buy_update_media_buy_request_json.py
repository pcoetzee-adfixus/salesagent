...
class UpdateMediaBuyRequest1(BaseModel):
    ...
    packages: Annotated[list[Packages | Packages5] | None, Field(description="Package-specific updates")] = (
        None
    )
...
class UpdateMediaBuyRequest2(BaseModel):
    ...
    packages: Annotated[list[Packages6 | Packages7] | None, Field(description="Package-specific updates")] = (
        None
    )
    push_notification_config: Annotated[
